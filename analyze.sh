...
TOOLS=(
    ...
    "ent:ent"
    "testu01:TestU01"
    #"nist_800_22:../../SP800-22sts/assess"
...
analyze_file() {
    ...
    for tool_entry in "${TOOLS[@]}"; do
        ...
        case $name in
            ...
            "testu01")
                log "Running TestU01"
                $cmd -smallcrush -i "$INPUT_FILE" > "$output_file"
                ;;
            "nist_800_22")
                log "Running NIST 800-22"
                echo "111111111111111" > nist_config.txt
                $cmd 0 "$INPUT_FILE" > "$output_file" 2>/dev/null
                ;;
            "nist_800_90b")
